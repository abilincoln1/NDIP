...
def get_emerging_stakeholders(db: Session, limit: int = 10, days: int = 30, top_tier_cutoff: int = 5) -> list:
    """
    ...
    the top composite_index tier. This avoids the easy trap of "emerging"
    just meaning "also high" -- it specifically surfaces stakeholders whose
    prominence is currently increasing rather than ones who are already
    platform-dominant.
    """
    all_ranked = get_top_influence_stakeholders(db, limit=50, days=days)
